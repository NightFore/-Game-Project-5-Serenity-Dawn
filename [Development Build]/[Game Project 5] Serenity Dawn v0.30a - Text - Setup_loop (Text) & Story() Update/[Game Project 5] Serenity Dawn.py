...
def Story_Text_Display():
    ...
    # Character Name
    Text_Display_Center(Story.L_Character, 100, 535, Text_Interface)
    Text_Display_Center(Story.R_Character, 1180, 535, Text_Interface) 

    # Text Left
    Text_Display(Story.L_Line[1], 5, 565, Text_Interface)
    Text_Display(Story.L_Line[2], 5, 585, Text_Interface)
    Text_Display(Story.L_Line[3], 5, 605, Text_Interface)
    Text_Display(Story.L_Line[4], 5, 625, Text_Interface)
    Text_Display(Story.L_Line[5], 5, 645, Text_Interface)
    Text_Display(Story.L_Line[6], 5, 665, Text_Interface)
    Text_Display(Story.L_Line[7], 5, 685, Text_Interface)

    # Text Right
    Text_Display(Story.R_Line[1], 725, 565, Text_Interface)
    Text_Display(Story.R_Line[2], 725, 585, Text_Interface)
    Text_Display(Story.R_Line[3], 725, 605, Text_Interface)
    Text_Display(Story.R_Line[4], 725, 625, Text_Interface)
    Text_Display(Story.R_Line[5], 725, 645, Text_Interface)
    Text_Display(Story.R_Line[6], 725, 665, Text_Interface)
    Text_Display(Story.R_Line[7], 725, 685, Text_Interface)
