...
class Story():
        ...
        if Story.textinput.update(Tools.events):
            ...
            if self.read == True:
                ...
                if "[L]" in self.read_line:
                    ...
                    # Left Text
                    self.text_line[0][index[0]]     = self.read_line.replace("[L]", "")
                    self.text_line[0][index[0]+1]   = "(-> Press Enter)"
                    self.text_line[1][index[1]+1]   = "(-> Press Enter)"
                    self.index[0] += 1
                ...
                if "[R]" in self.read_line:
                    ...
                    # Left Text
                    self.text_line[1][index[1]]     = self.read_line.replace("[R]", "")
                    self.text_line[1][index[1]+1]   = "(-> Press Enter)"
                    self.text_line[1][index[0]+1]   = "(-> Press Enter)"
                    self.index[1] += 1
    ...
    def display(self):
        ...
        if self.input_box == True:
            ...
            box_y   = self.input_y - self.input_height/2
