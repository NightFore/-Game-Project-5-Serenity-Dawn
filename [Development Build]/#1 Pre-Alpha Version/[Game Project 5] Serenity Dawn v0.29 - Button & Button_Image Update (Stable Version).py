...
class AnimatedSprite(pygame.sprite.Sprite):
    def __init__(self, x, y, center, path, dt, animation, action):
        ...
        #AnimatedSprite.load_images(path=Sprite.path[Sprite.index])
        ...
        self.animation_time     = animation     # Time before update
        self.current_time       = 0

            #self.animation_frames  = 6
        self.animation_frames   = animation     # Frame before update
