...
class Text():
    def __init__(self):
        ...
        # Text
        self.Character_Left     = ""                            # Character Name
        self.Line_Left          = ["","","","","","","","",""]  # Text
        self.Order_Left         = 1                             # Line

        self.Character_Right    = ""                            # Character Name
        self.Line_Right         = ["","","","","","","","",""]  # Text
        self.Order_Right        = 1                             # Line
Text = Text()
...
class AnimatedSprite(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.images = AnimatedSprite.load_images(path=Tools.Sprite_path[Tools.Sprite_index])    # Load all images
        ...
        self.animation_time     = Tools.Sprite_animation[Tools.Sprite_index]
        self.current_time       = 0

        #self.animation_frames  = 6
        self.animation_frames   = Tools.Sprite_animation[Tools.Sprite_index]
...
def Debug():
    ...
    for Tools.Sprite_index in range(Tools.Sprite_Number):
        ...
        Tools.Sprite_player.append(AnimatedSprite())
        Tools.Sprite_all_sprites.append(pygame.sprite.Group(AnimatedSprite()))
...
def Text_Input():
    ...
    if Text.textinput.update(Tools.events):
        ...
        if Text.Event == False:
            ...
            # Reset Text
            if Text.Order_Left == 7:
                Text.Line_Left = ["","","","","","","","",""]
                Text.Order_Left = 1

            if Text.Order_Right == 7:
                Text.Line_Right = ["","","","","","","","",""]
                Text.Order_Right = 1
        ...
        # Text
            ...
            if "[L]" in Text.Read:
                ...
                if "(NAME)" in Text.Read:
                    Text.Character_Left = Text.Read.replace("(NAME)[L]", "")
                    Text.Read = Text.File.readline().rstrip('\n').replace("%PlayerIG.name", ("%s" % GameState.Character[0].name))

                # Text
                Text.Line_Left[Text.Order_Left]     = Text.Read.replace("[L]", "")
                Text.Line_Left[Text.Order_Left+1]   = "(-> Press Enter)"
                Text.Line_Right[Text.Order_Right+1] = ""
                Text.Order_Left += 1
            ...
            # Right Side
                ...
                # Character Name
                if "(NAME)" in Text.Read:
                    Text.Character_Right = Text.Read.replace("(NAME)[R]", "")
                    Text.Read = Text.File.readline().rstrip('\n').replace("%PlayerIG.name", ("%s" % GameState.Character[0].name))

                # Text
                Text.Line_Right[Text.Order_Right]   = Text.Read.replace("[R]", "")
                Text.Line_Right[Text.Order_Right+1] = "(-> Press Enter)"
                Text.Line_Left[Text.Order_Left+1]   = ""
                Text.Order_Right += 1
...
def Story_Text_Display():
    ...
    # Character Name
    Text_Display_Center(Text.Character_Left   , 100, 535, Text_Interface)
    Text_Display_Center(Text.Character_Right  , 1180, 535, Text_Interface) 

    # Text Left
    Text_Display(Text.Line_Left[1], 5, 565, Text_Interface)
    Text_Display(Text.Line_Left[2], 5, 585, Text_Interface)
    Text_Display(Text.Line_Left[3], 5, 605, Text_Interface)
    Text_Display(Text.Line_Left[4], 5, 625, Text_Interface)
    Text_Display(Text.Line_Left[5], 5, 645, Text_Interface)
    Text_Display(Text.Line_Left[6], 5, 665, Text_Interface)
    Text_Display(Text.Line_Left[7], 5, 685, Text_Interface)

    # Text Right
    Text_Display(Text.Line_Right[1], 725, 565, Text_Interface)
    Text_Display(Text.Line_Right[2], 725, 585, Text_Interface)
    Text_Display(Text.Line_Right[3], 725, 605, Text_Interface)
    Text_Display(Text.Line_Right[4], 725, 625, Text_Interface)
    Text_Display(Text.Line_Right[5], 725, 645, Text_Interface)
    Text_Display(Text.Line_Right[6], 725, 665, Text_Interface)
    Text_Display(Text.Line_Right[7], 725, 685, Text_Interface)
