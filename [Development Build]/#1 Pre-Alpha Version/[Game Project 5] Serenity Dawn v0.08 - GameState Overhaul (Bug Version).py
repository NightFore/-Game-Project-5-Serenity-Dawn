...
def Game_ui_Fight():
    ...
    # Player
        if GameState.Character_Slot[i] == True:
            ...
            # Text
            Text_Display("%s"           % GameState.Character[i].name, Status_Name_X[i], Status_Bar_Text_Y[i], Text_Fight)
            Text_Display("HP: %i/%i"    % (GameState.Character[i].Health, GameState.Character[i].Maxhealth), Status_Health_X[i], Status_Bar_Text_Y[i], Text_Fight)
            ...
            Text_Display("AP: %i/100"   % (GameState.Character[i].Action_Point), Status_Action_X[i], Status_Bar_Text_Y[i], Text_Fight)
