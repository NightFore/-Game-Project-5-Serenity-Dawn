...
def Title_Screen():
    ...
    # Buttons
    Tools.Button.append(Button("Start",    Text_Button_1, 1*display_width/4, 3*display_height/4, display_width/8, display_height/12, 15, True, True, Color_Green, Color_Red, None, Test_Button_Click))
...
def OST_Gallery():
    ...
    for row in range(Row):
        for col in range(6):
            Tools.Button.append(Button("Music %i" % (Music_Selection+1), Text_Button_1,
                                       60+(40+display_width/8)*col, 100+(40+display_height/10)*row, display_width/8, display_height/10, 12,
                                       True, False, Color_Green, Color_Red, Music_Selection, Music_Play))
            Music_Selection += 1
