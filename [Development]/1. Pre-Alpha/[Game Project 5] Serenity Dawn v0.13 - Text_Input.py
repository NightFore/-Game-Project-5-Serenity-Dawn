...
class Tools():
    def __init__(self, name):
        ...
        self.Text_Order_Left    = 1
        self.Text_Order_Right   = 1
...
def Text_Input():
    ...
    if Tools.textinput.update(Tools.events):
        ...
        # Text Line
        if "[L]" in Tools.Text:
            Tools.Text_Line_Left[Tools.Text_Order_Left]     = Tools.Text.strip("[L]")
            ...
            Tools.Text_Line_Right[Tools.Text_Order_Right]   = Tools.Text.strip("[R]")
