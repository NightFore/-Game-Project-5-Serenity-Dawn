...
def Training():
    ...
    action = Action_Test
    Animated_Sprite_1("Data\Sprite_Button\Sprite_Button_Traning", display_width/2, display_height/2, True, action)
    ...
    while not gameExit:
        ...
        Tools.events = pygame.event.get()
        gameDisplay.blit(Tools.Background, (0,0))
        Animated_Sprite_2("Data\Sprite_Button\Sprite_Button_Traning", display_width/2, display_height/2, True, action)
...
def Animated_Sprite_1(Sprite_Path, x, y, center, action):
...
def Animated_Sprite_2(Sprite_Path, x, y, center, action):
