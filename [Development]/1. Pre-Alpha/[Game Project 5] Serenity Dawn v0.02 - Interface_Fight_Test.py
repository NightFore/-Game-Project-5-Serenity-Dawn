...
def Game_ui_Fight():
    ...
    # Player
        if GameState.Player_Slot[i] == True:
            ...
            pygame.draw.rect(gameDisplay, Color_Green, (Status_Action_Bar_X[0], Status_Bar_Image_Y[i]+10, 1.5 * GameState.Player[i].Action_Point, 40))
    ...
    # Enemy   
        if GameState.Enemy_Slot[i] == True:
            ...
            pygame.draw.rect(gameDisplay, Color_Green, (Status_Action_Bar_X[1], Status_Bar_Image_Y[i], GameState.Enemy[i].Action_Point, 16))
