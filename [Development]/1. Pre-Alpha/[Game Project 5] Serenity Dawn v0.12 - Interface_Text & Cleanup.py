...
def Story_Text_Display():
    ...
    # Text
    Text_Display(Tools.Text_Line[1], 5, 565, Text_Interface)
    Text_Display(Tools.Text_Line[2], 5, 585, Text_Interface)
    Text_Display(Tools.Text_Line[3], 5, 605, Text_Interface)
    Text_Display(Tools.Text_Line[4], 5, 625, Text_Interface)
    Text_Display(Tools.Text_Line[5], 5, 645, Text_Interface)
    Text_Display(Tools.Text_Line[6], 5, 665, Text_Interface)
    Text_Display(Tools.Text_Line[7], 5, 685, Text_Interface)
