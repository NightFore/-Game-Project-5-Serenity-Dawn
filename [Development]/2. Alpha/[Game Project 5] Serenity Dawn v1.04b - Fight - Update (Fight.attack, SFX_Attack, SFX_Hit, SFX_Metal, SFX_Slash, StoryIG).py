...
class Fight():
    def __init__(self):
        ...
        self.slot   = [True, True, False, False, False, False]
    ...
    def attack(self, target):
        ...
        Random_SFX = random.randint(0, len(self.character[0].SFX_Attack)-1)
        pygame.mixer.Sound(self.character[0].SFX_Attack[Random_SFX]).play()
