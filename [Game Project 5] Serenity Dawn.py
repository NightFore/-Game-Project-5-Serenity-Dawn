...
def Result():
    if Setup.result == False:
        ...
        # Experience
        Text("EXP : %i" % PlayerIG.Experience, 540, 180,  True, Text_Interface)
        Text("EXP : %i" % IrisIG.Experience,   540, 330, True, Text_Interface)
        Text("EXP : %i" % GyreiIG.Experience,  540, 480, True, Text_Interface)
        
        # Interface
        Text("Result",      760, 85,  True, Text_Interface)
        Text("Stage :",     760, 430, True, Text_Interface) ##################
        Text("Gold : ",     760, 480, True, Text_Interface) ##################
        Text("Inventory",   960, 85,  True, Text_Interface)
        Button("Next", Text_Button, 960, 455, 135, 90, 4, False, True, Color_Green, Color_Red, None, Inventory)
